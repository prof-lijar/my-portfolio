...
const MyProjects = () => {
  const projects: PortfolioProject[] = [
    ...
    {
      id: 7,
      externalUrl: 'https://dental-app-landing.vercel.app/',
      title: 'DailyDental',
      description: 'Oral health education app (구강 건강 교육 앱). Project Manager and back-end developer — built the back-end services, cloud deployment, and system foundation.',
      icons: ['React Native', 'Back-end API', 'Gemini', 'Cloud Infrastructure'],
